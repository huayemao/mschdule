...
export default class Settings extends Component {
  ...
  clearStorage = async () => {
    try {
      ...
      await this.context.setState({ user: null })
  ...
  render() {
    ...
    return (
      <View style={{ paddingTop: StatusBar.currentHeight, backgroundColor: 'white', flex: 1 }}>
        ...
        <Item containerStyle={{ backgroundColor: 'white' }} onPress={this.clearStorage} index={1} data={data}></Item>
        <Item containerStyle={{ backgroundColor: 'white' }} onPress={this.updateStorage} index={1} data={data1}></Item>
        <Item containerStyle={{ backgroundColor: 'white' }}  onPress={() => alert('敬请期待')} index={1} data={data2}></Item>
